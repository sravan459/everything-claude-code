...
- add-new-agent-command: Adds a new agent command documentation to the ECC bundle.
- add-new-skill-command: Adds a new skill command documentation to the ECC bundle.
