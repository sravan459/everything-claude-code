...
- add-new-agent-command: Adds documentation or command specification for creating a new agent in the system.
- add-new-skill-command: Adds documentation or command specification for creating a new skill in the system.
