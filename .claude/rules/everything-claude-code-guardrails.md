...
- add-new-skill-command: Adds documentation or command definition for a new skill to the system.
- add-new-agent-command: Adds documentation or command definition for a new agent to the system.
