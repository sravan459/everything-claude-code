...
- add-new-skill-command: Adds a new skill command to the everything-claude-code ECC bundle.
- add-new-agent-command: Adds a new agent command to the everything-claude-code ECC bundle.
